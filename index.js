 ...
 */
 function typewrite()
 {
     let str="<我愿意为一个人，写满整个世界的情诗<因为我喜欢她，因为......我也想给她哪怕一点点的浪漫<当代码不止是代码的时候，它就有了新的意义<余生还长，请多多指教!<";//利用<作为换行符 -作为空格
     let strp="";
     let i=0;
     function print1()
     {
...
let clickb=false;//判断播放按钮是否已经按过了，如果已经按过了才可以执行键盘事件
 ...
 let a=[
     {name:"A",yin:3, str:"<br><br><br>我并没有喜欢哪一种类型的人。如果我喜欢你，我喜欢的就只是你。<br><br>还有....,其他的键<br><br>那些都是关于你的声音。以及，找一下声音里关于你的线索。"},
     ...
     {name:"H" ,yin:4, str:"<br><br>你的双眸有遥远的冬雪，你的微笑有绚烂的夏阳，<br></br>你一转身便有花开为你，你一低头便有星辰黯然，<br></br>你在我心里，我便拥有全世界。"},
     ...
     {name:"L" ,yin:15, str:"<br><br><br><br>世界上美好的东西不太多,<br><br>立秋傍晚从河对岸吹来的风,<br><br>和二十来岁笑起来的你。"},
     ...
     {name:"Y" ,yin:1, str:"<br><br><br><br>月遇从云，花遇和风，<br><br>今晚上的夜空很美，<br><br>我又想你。"},
 ...
 function fl(e)
 {
     ...
     if((key<='z'&&key>='a')||(key<='Z'&&key>='A'))//避免大小写的错误
     {
         ...
         if(s.indexOf("LHYWXHN")!=-1&&records==0)
         {
             setTimeout(function()
             {
                 records=1;
                 ...
                 x.setAttribute("src", `./video/蒲公英的约定.mp3`);
                 x.setAttribute("autoplay","autoplay");
